...
const EmployeeSidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className="fixed top-4 left-4 z-50 p-2 rounded-md bg-yellow-500 text-white md:hidden shadow-lg"
      ...
      <div
        className={`
          fixed top-0 left-0 h-full w-64 bg-yellow-50 shadow-xl z-40 transition-transform duration-300 border-r border-yellow-300
